...
#region Auth Keys
...
#endif
#if CVR_TESLASUIT
            selectedsdks.Add("CVR_TESLASUIT");
#endif
        }
    ...
    void SelectSDKUpdate()
    {
        ...
        List<string> sdknames = new List<string>() { "Unity Default", "Unity XR", "HP Omnicept 1.6", "Oculus SDK 1.38", "SteamVR SDK 1.2", "SteamVR SDK 2.5.0", "Pupil Labs SDK 1.0 (eye tracking)", "Vive Pro Eye (eye tracking)", "Vive Wave 3.0.1", "Varjo 2.3 (eye tracking)","Teslasuit 1.0.4", "Pico Neo 2 Eye 2.8.4 (eye tracking)", "Windows Mixed Reality", "Tobii XR 1.8.0.168 (eye tracking)", "Fove SDK 3.1.2 (eye tracking)", "ARCore SDK (Android)", "ARKit SDK (iOS)", "Hololens SDK", "Neurable 1.4", "SnapdragonVR 3.0.1 SDK" };
        List<string> sdkdefines = new List<string>() { "CVR_DEFAULT", "CVR_XR", "CVR_OMNICEPT", "CVR_OCULUS", "CVR_STEAMVR", "CVR_STEAMVR2", "CVR_PUPIL", "CVR_VIVEPROEYE", "CVR_VIVEWAVE", "CVR_VARJO", "CVR_TESLASUIT", "CVR_PICONEO2EYE", "CVR_WINDOWSMR", "CVR_TOBIIVR", "CVR_FOVE", "CVR_ARCORE", "CVR_ARKIT", "CVR_HOLOLENS", "CVR_NEURABLE", "CVR_SNAPDRAGON" };
